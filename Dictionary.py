...
def search_word(word_entry=None, result_text=None):
...
def main():
    ...
    title = tk.Label(root, text="Simple Dictionary", fg="white", bg="#3E6BEC", font=("Helvetica", 16))
    title.pack(fill="x")
    ...
    search_button = ttk.Button(root, text="Search", command=lambda: search_word(word_entry, result_text))
